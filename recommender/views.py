...
def get_data(buisness_id):
    ...
    demographics = pd.DataFrame(demographics, columns=['id', 'target_audience_age_range', 'target_audience_gender', 'target_audience_income_range',
...
def get_recommendations(influencer_df, nd_sample):
    ...
    top_influencer_indices = similarity_scores_for_marketer.argsort()[-10:][::-1]
...
@api_view(['GET'])
def fetch_data(request, marketer_id):
    influencers, business = get_data(marketer_id)
