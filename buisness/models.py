...
class Campaigns(models.Model):
    ...
    creative_asset = models.CharField(max_length=255)
    breakdown = models.CharField(max_length=255)
    target_age = models.CharField(max_length=255)
    target_gender = ArrayField(models.CharField(max_length=255))
    target_income_level = models.CharField(max_length=255)
    ...
    content_formats = models.CharField(max_length=255)
    distribution_channels = models.CharField(max_length=255)
    offer_description = models.CharField(max_length=255)
    offer_terms = models.CharField(max_length=255)
